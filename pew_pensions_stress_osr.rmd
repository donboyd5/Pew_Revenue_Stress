...
fcorder <- c("cbo_jan2020", "moodys_dec2019", "cbo_jul2020", "moodys_jul2020p50",
...
fcorder <- c("cbo_jan2020", "moodys_dec2019")
...
fcast2 %>% 
  filter(stabbr=="MN", year %in% 2020:2026, scenario=="baseline", revtype=="iit") %>% 
...
f <- function(scen, st){
  comp %>%
    ...
    ggtitle("Comparison of Pew OSR forecast to Boyd model forecast",
            subtitle = paste0("For ", scen, " scenario, for: ", get_stname(st))) +
    theme_bw()
}
...
Here are the scenarios I am using (as of now):
  ...
  NJ     gov_bmxleg  cbo_jan2020   pew_covidbase precovid
